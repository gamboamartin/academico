...
class ac_alumno_html extends html_controler {
    ...
    public function input_nombre(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->input_text_required(disabled: false,name: 'nombre',place_holder: 'Nombre',row_upd: $row_upd,
            value_vacio: $value_vacio);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar input', data: $html);
        }
    ...
    public function input_apellido_paterno(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->input_text_required(disabled: false,name: 'apellido_paterno',
    ...
    public function input_apellido_materno(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->input_text(disabled: false,name: 'apellido_materno',place_holder: 'Apellido 2',
    ...
    public function input_matricula(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->input_text_required(disabled: false,name: 'matricula',place_holder: 'Matricula',row_upd: $row_upd,
            value_vacio: $value_vacio);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar input', data: $html);
        }
    ...
    public function input_correo(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->input_text_required(disabled: false,name: 'correo',place_holder: 'Correo',row_upd: $row_upd,
            value_vacio: $value_vacio);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar input', data: $html);
        }
    ...
    public function input_curp(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->input_text_required(disabled: false,name: 'curp',place_holder: 'CURP',row_upd: $row_upd,
            value_vacio: $value_vacio);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar input', data: $html);
        }
    ...
    public function input_telefono_fijo(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->input_text(disabled: false,name: 'telefono_fijo',place_holder: 'Telefono Fijo',
            required: false, row_upd: $row_upd, value_vacio: $value_vacio);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar input', data: $html);
        }
    ...
    public function input_telefono_movil(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->input_text(disabled: false,name: 'telefono_movil',place_holder: 'Telefono Movil',
            required: false, row_upd: $row_upd, value_vacio: $value_vacio);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar input', data: $html);
        }
    ...
    public function fec_fecha_nacimiento(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->fecha_required(disabled: false,name: 'fecha_nacimiento',
    ...
    public function fec_fecha_ingreso(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->fecha_required(disabled: false,name: 'fecha_ingreso',
