...
class controlador_ac_alumno extends system {
    ...
    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
        ...
        $obj_link = new link_ac_alumno(link: $link, registro_id: $this->registro_id);

        parent::__construct(html:$html_, link: $link,modelo:  $modelo, obj_link: $obj_link, paths_conf: $paths_conf);

        $this->titulo_lista = 'Alumno';

        $link_ac_alumno_pertenece_alta_bd = $obj_link->link_ac_alumno_pertenece_alta_bd(ac_alumno_id: $this->registro_id, link: $link);
        if(errores::$error){
    ...
    private function asigna_link_asigna_plantel_row(stdClass $row): array|stdClass
    {
        ...
        $link_asigna_plantel = $this->obj_link->link_con_id(accion: 'asigna_plantel', link: $this->link,
            registro_id: $row->ac_alumno_id, seccion: $this->tabla);
        if(errores::$error){
